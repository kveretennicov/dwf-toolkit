...
const wchar_t* const DWFPackageVersionTypeInfoExtension::kzDocumentType_EPlot     = DWFInterface::kzEPlot_ID;
const wchar_t* const DWFPackageVersionTypeInfoExtension::kzDocumentType_EModel    = DWFInterface::kzEModel_ID;
...
_DWFTK_API
DWFPackageVersionTypeInfoExtension::DWFPackageVersionTypeInfoExtension( const DWFString& zDocumentType )
throw()
...
_DWFTK_API
DWFPackageVersionTypeInfoExtension::~DWFPackageVersionTypeInfoExtension()
throw()
{
    ;
}
...
_DWFTK_API
bool
DWFPackageVersionTypeInfoExtension::addSection( DWFSection*   /*pSection*/,
...
_DWFTK_API
bool
DWFPackageVersionTypeInfoExtension::addGlobalSection( DWFGlobalSection* /*pSection*/ )
throw( DWFException )
{
    return true;
}
...
_DWFTK_API
bool
DWFPackageVersionTypeInfoExtension::write( const DWFString& /*zSourceProductVendor*/,
...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::prewriteManifest( DWF6PackageWriter&          /*rPackageWriter*/, 
...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::postwriteManifest( DWF6PackageWriter&         /*rPackageWriter*/,
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::postwriteSections( DWF6PackageWriter&         /*rPackageWriter*/, 
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
