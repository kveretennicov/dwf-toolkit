...
inline size_t _dwfcore_compare_ascii_strings_no_case( const char* a, const char* b )
{
    size_t len_a = DWFCORE_ASCII_STRING_LENGTH(a);
    size_t len_b = DWFCORE_ASCII_STRING_LENGTH(b);
    
    char* _a = DWFCORE_ALLOC_MEMORY( char, len_a );
    char* _b = DWFCORE_ALLOC_MEMORY( char, len_b );
    ...
    DWFCORE_ASCII_STRING_COPY( _a, a );
    DWFCORE_ASCII_STRING_COPY( _b, b );
    ...
    return DWFCORE_COMPARE_ASCII_STRINGS( a, b );
}   
#define DWFCORE_COMPARE_ASCII_STRINGS_NO_CASE( a, b )   \
    _dwfcore_compare_ascii_strings_no_case( a, b )
#endif
