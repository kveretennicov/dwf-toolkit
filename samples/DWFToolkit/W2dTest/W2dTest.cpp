...
//
// $Header: /Components/Internal/DWF Toolkit/v7.1/samples/DWFToolkit/W2dTest/W2dTest.cpp 6     8/19/05 1:05a Bangiav $
...
void write_test(bool binary, bool compression, const wchar_t* filename, int testList)
{
    ...
    switch( CTestFramework::Instance().GetClassFactoryType() )
    {
        ...
        {
            char buf[128];
            sprintf(buf, "File:%-10s Compression:%-5s Binary:%-5s\n\n", filename, compression?"true":"false", binary?"true":"false");
            OutputDebugStringA(buf);
            whip_file->set_filename ((const WT_Unsigned_Integer16*)filename);
            switch (testList)
            {
            case 0: // Page 1
    ...
    if ( CTestFramework::Instance().GetClassFactoryType() == CTestFramework::XAML )
    {
        ...
        WT_String zSrc((const WT_Unsigned_Integer16*) L"().,0123456789-=_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz \x30A4\x30B4\x30C4\x30D4 \x0682\x0692\x06A2\x06B2 \x0105\x0115\x0125\x0135" );
        WT_String zFontName((const WT_Unsigned_Integer16*) L"Arial");
        ...
        zFontName = (const WT_Unsigned_Integer16*) L"Times New Roman";
        zFontPath = zFontName;
        pFont->font_name().set( zFontName );
        ...
        zFontName = (const WT_Unsigned_Integer16*) L"Courier New";
        zFontPath = zFontName;
        pFont->font_name().set( zFontName );
...
int wmain(int /*argc*/, wchar_t* /*argv*/[], wchar_t* /*envp*/[])
{
    ...
    if( CTestFramework::Instance().DoWriteTests() )
    {
        if (CTestFramework::Instance().GetClassFactoryType() == CTestFramework::XAML )
        {
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___0", 0 /* page 1*/);
            printf("Page 1 Output file generated: w2dtest___0\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___1", 1 /* page 2*/);
            printf("Page 2 Output file generated: w2dtest___1\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___2", 2 /* page 3*/);
            printf("Page 3 Output file generated: w2dtest___2\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___3", 3 /* page 4*/);
            printf("Page 4 Output file generated: w2dtest___3\n");
        }
        else
        {
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___0.w2d", 0 /* page 1*/);
            printf("Page 1 Output file generated: w2dtest___0.w2d\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___1.w2d", 1 /* page 2*/);
            printf("Page 2 Output file generated: w2dtest___1.w2d\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___2.w2d", 2 /* page 3*/);
            printf("Page 3 Output file generated: w2dtest___2.w2d\n");
            write_test(/*binary=*/false,  /*compression=*/false,  /*filename=*/L"out\\w2dtest___3.w2d", 3 /* page 4*/);
            printf("Page 4 Output file generated: w2dtest___3.w2d\n");

            write_test(/*binary=*/true,   /*compression=*/false,  /*filename=*/L"out\\w2dtest_b_0.w2d", 0 /* page 1*/);
            printf("Page 1 Output file generated: w2dtest_b_0.w2d\n"); 
            write_test(/*binary=*/true,   /*compression=*/false,  /*filename=*/L"out\\w2dtest_b_1.w2d", 1 /* page 2*/);
            printf("Page 2 Output file generated: w2dtest_b_1.w2d\n"); 
            write_test(/*binary=*/true,   /*compression=*/false,  /*filename=*/L"out\\w2dtest_b_2.w2d", 2 /* page 3*/);
            printf("Page 3 Output file generated: w2dtest_b_2.w2d\n"); 
            write_test(/*binary=*/true,   /*compression=*/false,  /*filename=*/L"out\\w2dtest_b_3.w2d", 3 /* page 4*/);
            printf("Page 4 Output file generated: w2dtest_b_3.w2d\n"); 

            write_test(/*binary=*/true,   /*compression=*/true,   /*filename=*/L"out\\w2dtest_bc0.w2d", 0 /* page 1*/);
            printf("Page 1 Output file generated: w2dtest_bc0.w2d\n");
            write_test(/*binary=*/true,   /*compression=*/true,   /*filename=*/L"out\\w2dtest_bc1.w2d", 1 /* page 2*/);
            printf("Page 2 Output file generated: w2dtest_bc1.w2d\n");
            write_test(/*binary=*/true,   /*compression=*/true,   /*filename=*/L"out\\w2dtest_bc2.w2d", 2 /* page 3*/);
            printf("Page 3 Output file generated: w2dtest_bc2.w2d\n");
            write_test(/*binary=*/true,   /*compression=*/true,   /*filename=*/L"out\\w2dtest_bc3.w2d", 3 /* page 4*/);
    ...
    if( CTestFramework::Instance().DoReadTests() )
    {
        if (CTestFramework::Instance().GetClassFactoryType() == CTestFramework::XAML )
        {
            read_test(/*filename=*/L"out\\w2dtest___0", 0 /* page 1*/);
            read_test(/*filename=*/L"out\\w2dtest___1", 1 /* page 2*/);
            read_test(/*filename=*/L"out\\w2dtest___2", 2 /* page 3*/);
            read_test(/*filename=*/L"out\\w2dtest___3", 3 /* page 4*/);
        }
        else
        {
            read_test(/*filename=*/L"out\\w2dtest___0.w2d",0);
            read_test(/*filename=*/L"out\\w2dtest___1.w2d",1);
            read_test(/*filename=*/L"out\\w2dtest___2.w2d",2);
            read_test(/*filename=*/L"out\\w2dtest___3.w2d",3);

            read_test(/*filename=*/L"out\\w2dtest_b_0.w2d",0);
            read_test(/*filename=*/L"out\\w2dtest_b_1.w2d",1);
            read_test(/*filename=*/L"out\\w2dtest_b_2.w2d",2);
            read_test(/*filename=*/L"out\\w2dtest_b_3.w2d",3);

            read_test(/*filename=*/L"out\\w2dtest_bc0.w2d",0);
            read_test(/*filename=*/L"out\\w2dtest_bc1.w2d",1);
            read_test(/*filename=*/L"out\\w2dtest_bc2.w2d",2);
            read_test(/*filename=*/L"out\\w2dtest_bc3.w2d",3);
        }
    }

    //skip_test(/*filename=*/"out\\w2dtest___.w2d");
    //skip_test(/*filename=*/"out\\w2dtest_b_.w2d");
    //skip_test(/*filename=*/"out\\w2dtest_bc.w2d");
