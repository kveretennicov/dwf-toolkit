...
//
// $Header: /Components/Internal/DWF Toolkit/v7/samples/W2dTest/image.cpp 1     12/16/04 4:27p Klugj $
...
WT_Result write_image(WT_File & whip_file)
{
    ...
    {
        if (0!=_access("city24.jpg", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("city24.jpg", &st))
    ...
    {
        if (0!=_access("city8.jpg", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("city8.jpg", &st))
            return WT_Result::Unknown_File_Read_Error;
    ...
    {
        if (0!=_access("colors32.png", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("colors32.png", &st))
            return WT_Result::Unknown_File_Read_Error;
    ...
    {
        if (0!=_access("colors24.png", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("colors24.png", &st))
            return WT_Result::Unknown_File_Read_Error;
    ...
    {
        if (0!=_access("colors8.png", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("colors8.png", &st))
            return WT_Result::Unknown_File_Read_Error;
	...
	classFactory->Destroy(text);
    {
        if (0!=_access("g4_instrument.tif", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("g4_instrument.tif", &st))
            return WT_Result::Unknown_File_Read_Error;
    ...
    classFactory->Destroy(text);
    {
        if (0!=_access("bitonal.png", 0))
            return WT_Result::No_File_Open_Error;
        
        struct _stat st;
        if (0!=_stat("bitonal.png", &st))
            return WT_Result::Unknown_File_Read_Error;
    ...
    if (CTestFramework::Instance().GetClassFactoryType() != CTestFramework::XAML)
    {
	    ...
	    classFactory->Destroy(text);
        {
            if (0!=_access("fax.bit", 0))
                return WT_Result::No_File_Open_Error;
            
            struct _stat st;
            if (0!=_stat("fax.bit", &st))
                return WT_Result::Unknown_File_Read_Error;
	    ...
	    classFactory->Destroy(text);
        {
            if (0!=_access("jeff.rgb", 0))
                return WT_Result::No_File_Open_Error;
            
            struct _stat st;
            if (0!=_stat("jeff.rgb", &st))
                return WT_Result::Unknown_File_Read_Error;
	    ...
	    classFactory->Destroy(text);
        {
            if (0!=_access("jeff.rgba", 0))
                return WT_Result::No_File_Open_Error;
            
            struct _stat st;
            if (0!=_stat("jeff.rgba", &st))
                return WT_Result::Unknown_File_Read_Error;
        ...
        {
            if (0!=_access("pete.256", 0))
                return WT_Result::No_File_Open_Error;
            
            struct _stat st;
            if (0!=_stat("pete.256", &st))
                return WT_Result::Unknown_File_Read_Error;
