...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        //
        //  Let's add an image for testing
        //
        {
            DWFImageResource* pImage = 
                DWFCORE_ALLOC_OBJECT( DWFImageResource(L"Elephant",                     // title
                                                       DWFXML::kzRole_RasterOverlay,        // role
                                                       DWFMIME::kzMIMEType_JPG,             // MIME type
                                                       L"Autodesk, Inc.",                   // author
                                                       L"Overlay Image Sample",             // description
                                                       L"",                                 // creation time
                                                       L"") );                              // modification time
            ...
            // Transform A
            //
            // fit the width of the image to the width of the paper, since the image width > height
            // x-scale is paper_width / image_width_in_pixels
            // y-scale - use x-scale for uniform scaling
            // x-translation - 0; since the width of the image and paper are the same
            // y-translation - (paper_height - image_height_in_pixels * y-scale) / 2; this centers along the y-axis
            
            double anTransform[4][4] = { 0.019097222222222222222222222222222, 0, 0, 0,
                                         0, 0.019097222222222222222222222222222, 0, 0, 
                                         0, 0, 1, 0, 
                                         0, 0.583333, 0, 1 };
            ...
            // Transform B
            //
            // Based on transform A - scaled the image smaller by a factor of 2
            //
            // x-scale = (paper_width/image_width_in_pixels)/2
            // y-scale = x-scale [preserve aspect ratio]
            // x-translation = y-translation
            // y-translation = (paper_height - image_height_in_pixels * y-scale) / 2 [this centers image topleft along the y-axis]
            //            
            //double anTransform[4][4] = { 0.0095, 0, 0, 0,
            //                             0, 0.0095, 0, 0, 
            //                             0, 0, 1, 0, 
            //                             0.583333, 0.583333, 0, 1 };

            //
            // Transform C
            //
            // Based on transform B - rotated image 30 degrees counter-clockwise, about 0,0 (bottom-left) of image
            //
            // x-scale = (paper_width/image_width_in_pixels)/2 * cos(30deg) -> 0.0095*cos(30)
            // y-scale = x-scale [preserve aspect ratio]
            // xy = -yx = 0.0095*sin(30)
            // x-translation = y-translation
            // y-translation = (paper_height - image_height_in_pixels * y-scale) / 2 [this centers image topleft along the y-axis]
            //
            //double anTransform[4][4] = { 0.00822724, 0.00475000, 0, 0,
            //                             -0.0047500, 0.00822724, 0, 0, 
            //                             0., 0, 1, 0, 
            //                             0.583333, 0.583333, 0, 1 };
            ...
            // Transform D
            //
            // Based on transform B - rotated image 90 degrees counter-clockwise, about 0,0 (bottom-left) of image
            //
            // x-scale = (paper_width/image_width_in_pixels)/2 * cos(30deg) -> 0.0095*cos(30)
            // y-scale = x-scale [preserve aspect ratio]
            // xy = -yx = 0.0095*sin(30)
            ...
            // y-translation = (paper_height - image_height_in_pixels * y-scale) / 2 [this centers image topleft along the y-axis]
            //
            //double anTransform[4][4] = { 0, 0.0095, 0, 0,
            //                             -0.0095, 0, 0, 0, 
            //                             0., 0, 1, 0, 
            //                             0.583333, 0.583333, 0, 1 };

            //double anTransform[4][4] = { 0.0066666666666666671, 0, 0, 0,
            //                             0, 0.0066666666666666671, 0, 0, 0, 0, 1, 0, 3.5800000000000001, 2.9699999999999998, 0, 1 };
            double anClip[4] = { 0, 0, 11, 8.5 };
            double anOrigExtents[4] = { 0, 0, 576, 384 };
            ...
            // these resources.
            //
            DWFFile oJPGFilename( L"Elephant96dpi.jpg" );
        ...
        DWFXPackageWriter oWriter( oDWF );
