...
//
// $Header: //DWF/Development/Components/Internal/DWF Toolkit/v7.7/samples/DWFToolkit/W2dTest_Mac_Linux/color_map.cpp#1 $
...
WT_Result write_color_map(WT_File & whip_file)
{
	...
	WT_Text *text = classFactory->Create_Text();
	text->string() = "Simple color map";		
	text->position() = WT_Logical_Point(x, y-50);
    //WT_Text *text = classFactory->Create_Text(WT_Logical_Point(x, y-50), "Simple color map");
